...
import { statusOptions, kelasOptions } from '../data/data'
import { type Student } from '../data/schema'
import { siswaColumns as columns } from './siswa-columns'
...
export function SiswaTable({ data, search, navigate }: SiswaTableProps) {
