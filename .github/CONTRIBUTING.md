# Contributing to Edara

Thank you for considering contributing to **Edara**! Every contribution is valuable, whether it's reporting bugs, suggesting improvements, adding features, or refining README.
...
2. **Clone** your fork:
   ...
   ```bash
   git clone https://github.com/username/edara.git
   ```
...
Thank you for helping make **Edara** better! 🚀

If you have any questions, feel free to reach out via [Discussions](https://github.com/alarwasyi98/edara/discussions).
